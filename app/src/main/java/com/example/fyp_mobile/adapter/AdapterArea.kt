...
class AdapterArea(private val areaList : ArrayList<Area>, private val context: Context) :
    RecyclerView.Adapter<AdapterArea.HolderRecycle>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterArea.HolderRecycle {
    ...
    override fun onBindViewHolder(holder: AdapterArea.HolderRecycle, position: Int) {
