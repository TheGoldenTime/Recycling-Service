...
import com.example.fyp_mobile.databinding.ActivityAdminProfileBinding
...
class AdminProfileActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(mUserDetails.profileCompleted == 0){
            ...
            GlideLoader(this@AdminProfileActivity).loadUserPicture(mUserDetails.image, iv_user_photo)
...
//            }
        ...
        binding.ivUserPhoto.setOnClickListener(this@AdminProfileActivity)
        binding.btnSubmit.setOnClickListener(this@AdminProfileActivity)
        binding.btnLogout.setOnClickListener{
            FirebaseAuth.getInstance().signOut()
            val intent = Intent(this@AdminProfileActivity, LoginActivity::class.java)
...
//        userHashMap[Constants.GENDER] = gender
    ...
    fun userProfileUpdateSuccess(){
        ...
        startActivity(Intent(this@AdminProfileActivity, AdminProfActivity::class.java))
        finish()
    }
        ...
        if(resultCode == Activity.RESULT_OK){
            if(data != null){
                try{
                    ...
                    e.printStackTrace()
                    Toast.makeText(this@AdminProfileActivity,resources.getString(R.string.image_selection_failed), Toast.LENGTH_SHORT).show()
                }
            }
